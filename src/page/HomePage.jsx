      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-md-8">
            <h1 className="text-color">Welcome to Group Project Management System</h1>
            <p>
              A Group Project management system is a powerful tool designed to help
              individuals and teams efficiently organize, track, and accomplish
              their tasks and projects. By centralizing project in one place, it
            ...
            <p>
              ...
              personal use or within organizations, a group project management system
        ...
        <div className="row">
          ...
          <div className="col-md-8">
            ...
            <p className="ms-5">
              Utilizing project management tools, such as online group project management
